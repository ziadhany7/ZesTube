                                ...
                                <div class="row justify-content-center">
                                    ...
                                    if (isset($_POST['editChannel'])) {
                                        if (!empty($_POST['channelName'])) {
                                            ...
                                            $chan = new Channel();
                                            $result = $chan->EditChannelInfo($usrID,$chanName);
                                            if ($result == "Name Changed Successfully") {
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Edit Channel Name</p>
                                        <form class="mx-1 mx-md-4" method="post" autocomplete="off" enctype="multipart/form-data">
                                            ...
                                            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                                <input type="submit" value="Change" class="btn btn-outline-danger btn-lg" name="editChannel">
                                            </div>
                                        </form>
                                    </div>
                                </div>
