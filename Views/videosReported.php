      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Reported Videos</h4>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      foreach ($result as $row) {
                        ...
                        echo "<td>" . $row['reportedVideo_ID'] . "</td>";
                        echo "<td>
                                  <button type='button' class='btn btn-outline-danger btn-rounded btn-fw'><a class='text-light' href='./delete.php?reportedID=" . $row['reportedVideo_ID'] . "&report=" . $row['report_ID'] . "' style='text-decoration:none;'>Delete</a></button>
                                </td>";
                        echo "</tr>";
                      }
                      ?>
