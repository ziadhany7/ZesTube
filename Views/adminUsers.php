                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      foreach ($result as $row) {
                        ...
                        echo "<td>
                                  <button type='button' class='btn btn-outline-danger btn-rounded btn-fw'><a class='text-light' href='./delete.php?userID=" . $row['user_ID'] . "' style='text-decoration:none;'>Delete</a></button>
                                </td>";
                        echo "</tr>";
                      }
                      ?>
